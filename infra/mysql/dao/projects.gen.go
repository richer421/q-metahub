...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.GitID = field.NewInt64(tableName, "git_id")
	_project.Name = field.NewString(tableName, "name")
	_project.RepoURL = field.NewString(tableName, "repo_url")
...
func (p *project) updateTableName(table string) *project {
	...
	p.GitID = field.NewInt64(table, "git_id")
	p.Name = field.NewString(table, "name")
	p.RepoURL = field.NewString(table, "repo_url")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["git_id"] = p.GitID
	p.fieldMap["name"] = p.Name
	p.fieldMap["repo_url"] = p.RepoURL
}
