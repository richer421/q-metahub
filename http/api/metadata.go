...
func ListBusinessUnitDeployPlans(c *gin.Context) {
	businessUnitID, err := strconv.ParseInt(c.Param("id"), 10, 64)
	if err != nil {
		common.Fail(c, fmt.Errorf("invalid business unit id"))
		return
	...
	res, err := metadata.App.ListBusinessUnitDeployPlans(
		c.Request.Context(),
		businessUnitID,
		page,
		pageSize,
...
func GetDeployPlan(c *gin.Context) {
	deployPlanID, err := strconv.ParseInt(c.Param("id"), 10, 64)
	if err != nil {
		common.Fail(c, fmt.Errorf("invalid deploy plan id"))
		return
	}

	res, err := metadata.App.GetDeployPlan(c.Request.Context(), deployPlanID)
	if err != nil {
		common.Fail(c, err)
		return
	}
...
func CreateBusinessUnitDeployPlan(c *gin.Context) {
	businessUnitID, err := strconv.ParseInt(c.Param("id"), 10, 64)
	if err != nil {
		common.Fail(c, fmt.Errorf("invalid business unit id"))
		return
	...
	var req vo.UpsertDeployPlanReq
	if err := c.ShouldBindJSON(&req); err != nil {
		common.Fail(c, err)
		return
	}

	res, err := metadata.App.CreateBusinessUnitDeployPlan(c.Request.Context(), businessUnitID, req)
	if err != nil {
		common.Fail(c, err)
		return
	}
...
func UpdateDeployPlan(c *gin.Context) {
	deployPlanID, err := strconv.ParseInt(c.Param("id"), 10, 64)
	if err != nil {
		common.Fail(c, fmt.Errorf("invalid deploy plan id"))
		return
	...
	res, err := metadata.App.UpdateDeployPlan(c.Request.Context(), deployPlanID, req)
	if err != nil {
		common.Fail(c, err)
		return
	}
...
func DeleteDeployPlan(c *gin.Context) {
	...
	if err := metadata.App.DeleteDeployPlan(c.Request.Context(), deployPlanID); err != nil {
		common.Fail(c, err)
		return
	}
